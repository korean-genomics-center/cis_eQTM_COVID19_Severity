...
def plot_trend(df, dict_deg, path_analysis, colgene="Gene", colTPM="TPM", coltime="Time", coltrial="Trial", coldirec="Direction", split_by="Severity_Binary"):
    ...
    figure.map(sns.violinplot, coltime, colTPM, split_by, hue_order=df[split_by].unique(), order=df[coltime].unique())
...
if __name__ == "__main__":
    ...
    for visit_compare in list_visit_compare:
        ...
        path_deg = f"/BiO/Research/Project2/Infectomics_COVID-19_Host/Resources/Infectomics_COVID-19_RNA/Backup/Copy_from_Shrimp/COVID19Infected/Results/5_deg/{visit_compare}_DEG_20230904.tsv"
